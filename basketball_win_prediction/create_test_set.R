...
url <- 'https://www.basketball-reference.com/leagues/NBA_2017_games.html'
session <- html_session(url)
team.names <- read.csv("Data/teamsOctoberTest.csv")
...
url <- 'https://www.basketball-reference.com/leagues/NBA_2017_games-november.html'
session <- html_session(url)
team.names <- read.csv("Data/teamsNovemberTest.csv")
...
url <- 'https://www.basketball-reference.com/leagues/NBA_2017_games-december.html'
session <- html_session(url)
team.names <- read.csv("Data/teamsDecemberTest.csv")
...
write.csv(main.table, "Data/OctoberDecGameDataTest.csv")

team.data <- read.csv("Data/OctoberDecGameDataTest.csv")
...
write.csv(boston_culm_stats, "Data/CulmStats/boston2.csv");
...
write.csv(cleveland_culm_stats, "Data/CulmStats/cleveland2.csv");
...
write.csv(houston_culm_stats, "Data/CulmStats/houston2.csv");
...
write.csv(golden_culm_stats, "Data/CulmStats/golden2.csv");
...
write.csv(milwaukee_culm_stats, "Data/CulmStats/milwaukee2.csv");
...
write.csv(atlanta_culm_stats, "Data/CulmStats/atlanta2.csv");
...
write.csv(dallas_culm_stats, "Data/CulmStats/dallas2.csv");
...
write.csv(charlotte_culm_stats, "Data/CulmStats/charlotte2.csv");
...
write.csv(detroit_culm_stats, "Data/CulmStats/detroit2.csv");
...
write.csv(brooklyn_culm_stats, "Data/CulmStats/brooklyn2.csv");
...
write.csv(indiana_culm_stats, "Data/CulmStats/indiana2.csv");
...
write.csv(orleans_culm_stats, "Data/CulmStats/orleans2.csv");
...
write.csv(memphis_culm_stats, "Data/CulmStats/memphis2.csv");
...
write.csv(miami_culm_stats, "Data/CulmStats/miami2.csv");
...
write.csv(orlando_culm_stats, "Data/CulmStats/orlando2.csv");
...
write.csv(portland_culm_stats, "Data/CulmStats/portland2.csv");
...
write.csv(phoenix_culm_stats, "Data/CulmStats/phoenix2.csv");
...
write.csv(sacramento_culm_stats, "Data/CulmStats/sacramento2.csv");
...
write.csv(san.antonio_culm_stats, "Data/CulmStats/san_antonio2.csv");
...
write.csv(minnesota_culm_stats, "Data/CulmStats/minnesota2.csv");
...
write.csv(denver_culm_stats, "Data/CulmStats/denver2.csv");
...
write.csv(utah_culm_stats, "Data/CulmStats/utah2.csv");
...
write.csv(philly_culm_stats, "Data/CulmStats/philly2.csv");
...
write.csv(knicks_culm_stats, "Data/CulmStats/knicks2.csv");
...
write.csv(washington_culm_stats, "Data/CulmStats/washington2.csv");
...
write.csv(clippers_culm_stats, "Data/CulmStats/clippers2.csv");
...
write.csv(lakers_culm_stats, "Data/CulmStats/lakers2.csv");
...
write.csv(oklahoma_culm_stats, "Data/CulmStats/oklahoma2.csv");
...
write.csv(toronto_culm_stats, "Data/CulmStats/toronto2.csv")
...
boston <- read.csv("Data/CulmStats/boston2.csv")
cleveland <- read.csv("Data/CulmStats/cleveland2.csv")
houston <- read.csv("Data/CulmStats/houston2.csv")
golden <- read.csv("Data/CulmStats/golden2.csv")
milwaukee <- read.csv("Data/CulmStats/milwaukee2.csv")
atlanta <- read.csv("Data/CulmStats/atlanta2.csv")
dallas <- read.csv("Data/CulmStats/dallas2.csv")
charlotte <- read.csv("Data/CulmStats/charlotte2.csv")
detroit <- read.csv("Data/CulmStats/detroit2.csv")
brooklyn <- read.csv("Data/CulmStats/brooklyn2.csv")
indiana <- read.csv("Data/CulmStats/indiana2.csv")
orleans <- read.csv("Data/CulmStats/orleans2.csv")
memphis <- read.csv("Data/CulmStats/memphis2.csv")
miami <- read.csv("Data/CulmStats/miami2.csv")
orlando <- read.csv("Data/CulmStats/orlando2.csv")
portland <- read.csv("Data/CulmStats/portland2.csv")
phoenix <- read.csv("Data/CulmStats/phoenix2.csv")
houston <- read.csv("Data/CulmStats/houston2.csv")
sacramento <- read.csv("Data/CulmStats/sacramento2.csv")
san.antonio <- read.csv("Data/CulmStats/san_antonio2.csv")
minnesota <- read.csv("Data/CulmStats/minnesota2.csv")
denver <- read.csv("Data/CulmStats/denver2.csv")
utah <- read.csv("Data/CulmStats/utah2.csv")
philly <- read.csv("Data/CulmStats/philly2.csv")
knicks <- read.csv("Data/CulmStats/knicks2.csv")
washington <- read.csv("Data/CulmStats/washington2.csv")
clippers <- read.csv("Data/CulmStats/clippers2.csv")
lakers <- read.csv("Data/CulmStats/lakers2.csv")
oklahoma <- read.csv("Data/CulmStats/oklahoma2.csv")
toronto <- read.csv("Data/CulmStats/toronto2.csv")
...
write.csv(game.scores, "Data/2017OctoberDecStatsTest.csv")
write.csv(winning.team, "Data/2017WinsOctoberDecTest.csv")
